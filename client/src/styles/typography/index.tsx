...
export const BlockQuote: FC<{
  ...
  return (
    <blockquote
      className={`border-l-4 pl-4 italic text-gray-400 ${className}`}
      {...props}
    >
      {children}
    </blockquote>
...
export const Ul: FC<{
  ...
  return (
    <ul className={`list-disc ml-10 ${className}`} {...props}>
      {children}
    </ul>
  );
};
...
export const Ol: FC<{
  ...
  return (
    <ol className={`list-decimal ml-10 ${className}`} {...props}>
      {children}
    </ol>
  );
};
...
export const Tag: FC<{
  ...
  return (
    <span
      className={`bg-blue-100 text-blue-600 p-2 rounded-full text-xs font-medium ${className}`}
      {...props}
    >
      {children}
    </span>
